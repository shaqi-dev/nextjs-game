...
const GameSettings: FC<GameSettingsProps> = ({
  ...
  const handleSetValuesIdx = (e: ChangeEvent<HTMLInputElement>) => onChangeValues(+e.target.value);
  ...
  return (
    <OuterRect>
      <InnerRect>
        ...
        <OrderOptions>
          <OrderButton disabled={order === GameOrder.ASC} onClick={handleSetOrderASC}>
            По возрастанию
          </OrderButton>
          <OrderButton disabled={order === GameOrder.DESC} onClick={handleSetOrderDESC}>
            По убыванию
          </OrderButton>
        </OrderOptions>
